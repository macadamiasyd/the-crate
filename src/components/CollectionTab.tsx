      ...
      <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
        ...
        <div className="flex gap-2 sm:gap-3">
          ...
          <button
            ...
            className="flex-1 sm:flex-none px-4 py-2 bg-surface2 text-cream-dim border border-border rounded text-sm hover:text-cream transition-colors whitespace-nowrap shrink-0"
          >
            Bulk Import
          </button>
        </div>
